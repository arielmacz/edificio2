...
class ApartamentosControllerTest < ActionController::TestCase
  ...
  test "should create apartamento" do
    assert_difference('Apartamento.count') do
      post :create, apartamento: { estado: @apartamento.estado, inquilino: @apartamento.inquilino, mensualidad: @apartamento.mensualidad, mes: @apartamento.mes, meses: @apartamento.meses, numero: @apartamento.numero }
    end
  ...
  test "should update apartamento" do
    put :update, id: @apartamento, apartamento: { estado: @apartamento.estado, inquilino: @apartamento.inquilino, mensualidad: @apartamento.mensualidad, mes: @apartamento.mes, meses: @apartamento.meses, numero: @apartamento.numero }
    assert_redirected_to apartamento_path(assigns(:apartamento))
  end
